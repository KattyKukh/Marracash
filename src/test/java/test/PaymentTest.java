...
public class PaymentTest {
    ...
    @Test
    @DisplayName("Should success pay if valid card")
    void successPayIfValidCard() {
        var mainPage = open(urlApp, MainPage.class);
        var validCardInfo = DataHelper.generateValidApprovedCard();
        var orderPage = mainPage.selectPay();
        orderPage.checkSelectPay();
    ...
    @Test
    @DisplayName("Should success pay if card expires")
